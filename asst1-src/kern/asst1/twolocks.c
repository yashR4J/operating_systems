...
/*
locka has higher precedence than lockb and must be acquired before lockb if a
process requires both locks. As per the resource ordering scheme, this ensures
